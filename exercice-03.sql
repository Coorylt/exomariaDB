...
SELECT * 
FROM student
where (email LIKE '%.fr%' or create_date <='2021-01-10 00:00:00')
-- Exo 3.2
-- Listez les students :
-- - dont l'email contient la chaîne de caractères `.fr`
...
SELECT * 
FROM student
where (create_date >='2021-01-01 00:00:00')
...
SELECT * 
FROM project
where (description <>'Dolores' or create_date >='2021-07-01 00:00:00')
-- Exo 3.5
-- Listez les projects :
-- - dont la description ne contient pas la chaîne de caractères `Dolores`
...
AND create_date >='2021-01-01 00:00:00'
-- Exo 3.6
-- Listez les projects :
...
SELECT * 
FROM project 
WHERE create_date >='2021-07-01 00:00:00'
AND create_date <= '2021-07-01 00:00:00'
-- Exo 3.7
-- Listez les students :
...
SELECT *
FROM students
WHERE (email LIKE '%.fr%' AND creation_date <= '2021-01-10')
...
SELECT * 
from student 
where (email LIKE '%.fr%' AND create_date <= '2021-01-10 00:00:00')
AND project IS NULL